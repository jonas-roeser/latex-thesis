...
# LaTeX Preamble:
# ---
# % GRAPHICX: required for inserting graphics
# \RequirePackage{graphicx}
#     \graphicspath{{Resources}} % set default graphics import path

# Usage:
# ---
# \includegraphics[width=.5\textwidth]{Resources/figure.png}
...
# Save figure
fig.savefig('figure.png', dpi=300) # set dpi for any rasterized parts of figure
plt.show()
plt.close()