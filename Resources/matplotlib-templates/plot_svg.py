...
# LaTeX Preamble:
# ---
# % SVG: required for inserting vector graphics
# \RequirePackage{svg}
#     \svgpath{{Resources}} % set default svg import path

# Usage:
# ---
# \includesvg[width=.5\textwidth, inkscapelatex=False]{Resources/figure.svg}
...
# Save figure
fig.savefig('figure.svg', dpi=300) # set dpi for any rasterized parts of figure
plt.show()
plt.close()